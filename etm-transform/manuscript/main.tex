% TODO: add the implementation of the protocols in the abstract.
% DONE: added "We also implemented key exchange protocols and measured..."

% TODO: remove 768/1024 security level data, add remarks about 128-bit tag security.
% DONE: removed Poly1305 data with ML-KEM-768/1024
%   GCM's tag is up to 128 bits: https://nvlpubs.nist.gov/nistpubs/legacy/sp/nistspecialpublication800-38d.pdf
%   CMAC's tag is up to 128 bits because it uses AES as underlying block cipher
