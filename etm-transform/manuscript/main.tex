...
\begin{proof}
    ...
    Across all $q$ decapsulation queries, the probability that at least one query is a forgery is thus at most $q \cdot \adv_\texttt{OT-MAC}(C)$. By the difference lemma:
