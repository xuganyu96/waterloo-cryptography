...
When instantiating \texttt{ML-KEM-ETM}, there are a variety of message authentication codes to choose from. We selected four categories that cover a wide range of designs: \begin{enumerate}
    ...
    \item KMAC-256, which is a keyed hash function based on Keccak
\end{enumerate}
...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        \multicolumn{2}{|c|}{Ciphertext size (bytes): }
        & \multicolumn{2}{|c|}{768} \\
        \hline
        \multicolumn{2}{|c|}{Poly1305}
        & \multicolumn{2}{|c|}{GMAC} \\
        \hline
        Median & 909 & Median & 3899 \\
        \hline
        Average & 2823 & Average & 4859 \\
        \hline
        \multicolumn{2}{|c|}{CMAC}
        & \multicolumn{2}{|c|}{KMAC} \\
        \hline
        Median & 6291 & Median & 7565 \\
        \hline
        Average & 6373 & Average & 7791 \\
        \hline
    \end{tabular}
\end{table}
