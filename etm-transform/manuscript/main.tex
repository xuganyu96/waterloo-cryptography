% TODO: Section 6 confusion
% DONE: deleted

% TODO: remove indents
% DONE: we should not do it; other accepted CHES papers kept the default indent, so we should do the same
...
\begin{abstract}
    ...
    %by applying the encrypt-then-MAC transformation to the PKE sub-routines of ML-KEM and 
