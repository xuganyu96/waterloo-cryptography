...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        \multirow{2}{*}{KEM variant}
        & \multirow{2}{*}{Client TX size}
        & \multirow{2}{*}{Server TX size}
        & \multicolumn{2}{|c|}{RTT time ($\us$)} \\
        \cline{4-5}
        & & & Median & Average \\
        \hline
        \texttt{ML-KEM-512} & ??? & ??? & 92 & 97 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ Poly1305 & ??? & ??? & 70 & 72 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ GMAC & ??? & ??? & 73 & 76 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ CMAC & ??? & ??? & 75 & 79 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ KMAC & ??? & ??? & 76 & 78 \\
        \hline
    \end{tabular}\vspace{0.3cm}
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        ...
        & & & Median & Average \\
        \hline
        \texttt{ML-KEM-768} & ??? & ??? & 135 & 140 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ Poly1305 & ??? & ??? & 99 & 104 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ GMAC & ??? & ??? & 101 & 105 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ CMAC & ??? & ??? & 103 & 109 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ KMAC & ??? & ??? & 103 & 107 \\
        \hline
    \end{tabular}\vspace{0.3cm}
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        ...
        & & & Median & Average \\
        \hline
        \texttt{ML-KEM-1024} & ??? & ??? & 193 & 199 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ Poly1305 & ??? & ??? & 138 & 141 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ GMAC & ??? & ??? & 140 & 145 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ CMAC & ??? & ??? & 143 & 148 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ KMAC & ??? & ??? & 144 & 149 \\
        \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        & & & Median & Average \\
        \hline
        \texttt{ML-KEM-512} & ??? & ??? & 145 & 151 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ Poly1305 & ??? & ??? & 103 & 106 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ GMAC & ??? & ??? & 106 & 110 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ CMAC & ??? & ??? & 108 & 112 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ KMAC & ??? & ??? & 109 & 113 \\
        \hline
    \end{tabular}\vspace{0.3cm}
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        ...
        & & & Median & Average \\
        \hline
        \texttt{ML-KEM-768} & ??? & ??? & 215 & 222 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ Poly1305 & ??? & ??? & 144 & 150 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ GMAC & ??? & ??? & 149 & 156 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ CMAC & ??? & ??? & 153 & 160 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ KMAC & ??? & ??? & 154 & 159 \\
        \hline
    \end{tabular}\vspace{0.3cm}
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        ...
        & & & Median & Average \\
        \hline
        \texttt{ML-KEM-1024} & ??? & ??? & 310 & 318 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ Poly1305 & ??? & ??? & 202 & 209 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ GMAC & ??? & ??? & 212 & 228 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ CMAC & ??? & ??? & 212 & 218 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ KMAC & ??? & ??? & 213 & 220 \\
        \hline
    \end{tabular}
\end{table}
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        & & & Median & Average \\
        \hline
        \texttt{ML-KEM-512} & ??? & ??? & 220 & 213 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ Poly1305 & ??? & ??? & 133 & 138 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ GMAC & ??? & ??? & 139 & 143 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ CMAC & ??? & ??? & 143 & 148 \\
        \hline
        $\texttt{ML-KEM-512}^+$ w/ KMAC & ??? & ??? & 145 & 151 \\
        \hline
    \end{tabular}\vspace{0.3cm}
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        ...
        & & & Median & Average \\
        \hline
        \texttt{ML-KEM-768} & ??? & ??? & 294 & 301 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ Poly1305 & ??? & ??? & 190 & 196 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ GMAC & ??? & ??? & 197 & 210 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ CMAC & ??? & ??? & 202 & 208 \\
        \hline
        $\texttt{ML-KEM-768}^+$ w/ KMAC & ??? & ??? & 204 & 210 \\
        \hline
    \end{tabular}\vspace{0.3cm}
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        ...
        & & & Median & Average \\
        \hline
        \texttt{ML-KEM-1024} & ??? & ??? & 512 & 511 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ Poly1305 & ??? & ??? & 266 & 273 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ GMAC & ??? & ??? & 273 & 282 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ CMAC & ??? & ??? & 280 & 287 \\
        \hline
        $\texttt{ML-KEM-1024}^+$ w/ KMAC & ??? & ??? & 282 & 288 \\
        \hline
    \end{tabular}
\end{table}
