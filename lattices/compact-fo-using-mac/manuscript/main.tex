...
\begin{proof}
    % Game 1: replace pseudorandom coin with random coin and use QUERY* argument, this time we will lose q_H * epsilon amount of security, probably

    % Game 1 can be simulated by OW-CPA adversary
\end{proof}
